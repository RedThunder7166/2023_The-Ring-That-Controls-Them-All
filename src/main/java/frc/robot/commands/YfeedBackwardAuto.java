...
public class YfeedBackwardAuto extends CommandBase {
 ...
 private double feedForward = -3.5;
  ...
  public YfeedBackwardAuto(Swerve swerve, double targetX, double targetY, double targetRot) {
    s_Swerve = swerve;
  ...
  public void execute() {
    ...
    double y = y_kP * y_error + feedForward ;
